! function (t) {
   ...
   function r(t, e) {
      var n, r, i, a;
      return i = e.split("."), r = i[0], a = i[1], n = t.components[r] || AFRAME.components[r], n ? a && !n.schema[a] ? null : a ? n.schema[a].type : n.schema.type : null
   }
   ...
   function a(t, e, n) {
      var r;
      for (r = 0; r < e.length; r++) t.addEventListener(e[r], n)
   }

   function o(t, e, n) {
      var r;
      for (r = 0; r < e.length; r++) t.removeEventListener(e[r], n)
   }

   function s(t, e) {
      var n, r, i;
      for (r = f(e), i = t, n = 0; n < r.length; n++) i = i[r[n]];
      return i
   }

   function u(t, e, n, r) {
      var i, a, o, s;
      for (a = f(e), s = t, i = 0; i < a.length - 1; i++) s = s[a[i]];
      return o = a[a.length - 1], r === v ? void("r" in s[o] ? (s[o].r = n.r, s[o].g = n.g, s[o].b = n.b) : (s[o].x = n.r, s[o].y = n.g, s[o].z = n.b)) : void(s[o] = n)
   }

   function f(t) {
      return t in y ? y[t] : (y[t] = t.split("."), y[t])
   }
   ...
   var c = n(1);
   if (AFRAME.anime = c, "undefined" == typeof AFRAME) throw new Error("Component attempted to register before AFRAME was available.");
   var p = new THREE.Color,
      d = new THREE.Color,
      h = AFRAME.utils,
      m = h.entity.getComponentProperty,
      g = h.entity.setComponentProperty,
      y = {},
      v = "color",
      b = "position",
      A = "rotation",
   ...
   AFRAME.registerComponent("animation", {
      ...
      update: function () {
         var t = this.config,
            e = this.data;
         this.animationIsPlaying = !1, e.property && (t.autoplay = !1, t.direction = e.dir, t.duration = e.dur, t.easing = e.easing, t.elasticity = e.elasticity, t.loop = e.loop, this.createAndStartAnimation())
      },
      tick: function (t, e) {
      ...
      createAndStartAnimation: function () {
         var t = this.data;
         if (this.updateConfig(), this.animationIsPlaying = !1, this.animation = c(this.config), this.removeEventListeners(), this.addEventListeners(), !(!t.autoplay || t.startEvents && t.startEvents.length)) return t.delay ? void setTimeout(this.beginAnimation, t.delay) : void this.beginAnimation()
      },
      ...
      updateConfigForRawColor: function () {
         var t, e, n, r = this.config,
            i = this.data,
            a = this.el;
         if (!this.waitComponentInitRawProperty(this.updateConfigForRawColor)) {
            t = i.from || s(a, i.property), n = i.to, this.setColorConfig(t, n), t = this.fromColor, n = this.toColor, this.targetsArray.length = 0, this.targetsArray.push(t), r.targets = this.targetsArray;
            for (e in n) r[e] = n[e];
            r.update = function () {
               var e = {};
               return e.r = t.r, e.g = t.g, e.b = t.b,
                  function (t) {
                     var n;
                     n = t.animatables[0].target, n.r === e.r && n.g === e.g && n.b === e.b || u(a, i.property, n, i.type)
                  }
            }()
         }
      },
      updateConfigForDefault: function () {
         var t, e, n, r, i = this.config,
            a = this.data,
            o = this.el;
         this.waitComponentInitRawProperty(this.updateConfigForDefault) || (t = a.from || (l(a) ? s(o, a.property) : m(o, a.property)), r = a.to, n = !isNaN(t || r), n ? (t = parseFloat(t), r = parseFloat(r)) : (t = t ? t.toString() : t, r = r ? r.toString() : r), e = "true" === r || "false" === r, e && (t = "true" === a.from ? 1 : 0, r = "true" === a.to ? 1 : 0), this.targets.aframeProperty = t, i.targets = this.targets, i.aframeProperty = r, i.update = function () {
            ...
            return function (t) {
               var r;
               r = t.animatables[0].target.aframeProperty, r !== n && (n = r, e && (r = r >= 1), l(a) ? u(o, a.property, r, a.type) : g(o, a.property, r))
            }
         }())
      },
      updateConfigForVector: function () {
         var t, e, n, r = this.config,
            a = this.data,
            o = this.el;
         e = a.from ? AFRAME.utils.coordinates.parse(a.from) : m(o, a.property), n = AFRAME.utils.coordinates.parse(a.to), a.property === A && (i(e), i(n)), this.targetsArray.length = 0, this.targetsArray.push(e), r.targets = this.targetsArray;
         for (t in n) r[t] = n[t];
         return a.property === b || a.property === A || a.property === x ? void(r.update = function () {
            ...
            return t.x = e.x, t.y = e.y, t.z = e.z,
               function (e) {
                  ...
                  n.x === t.x && n.y === t.y && n.z === t.z || (t.x = n.x, t.y = n.y, t.z = n.z, o.object3D[a.property].set(n.x, n.y, n.z))
               }
         }()) : void(r.update = function () {
            var t = {};
            return t.x = e.x, t.y = e.y, t.z = e.z,
               function (e) {
                  var n = e.animations[0].target;
                  n.x === t.x && n.y === t.y && n.z === t.z || (t.x = n.x, t.y = n.y, t.z = n.z, g(o, a.property, n))
               }
         }())
      },
      updateConfig: function () {
         var t;
         t = r(this.el, this.data.property), l(this.data) && this.data.type === v ? this.updateConfigForRawColor() : "vec2" === t || "vec3" === t || "vec4" === t ? this.updateConfigForVector() : this.updateConfigForDefault()
      },
      waitComponentInitRawProperty: function (t) {
         var e, n = this.data,
            r = this.el;
         return !n.from && (!!n.property.startsWith(E) && (e = f(n.property)[1], !r.components[e] && (r.addEventListener("componentinitialized", function n(i) {
            i.detail.name === e && (t(), r.removeEventListener("componentinitialized", n))
         }), !0)))
      },
      stopRelatedAnimations: function () {
         var t, e;
         for (e in this.el.components) t = this.el.components[e], e !== this.attrName && "animation" === t.name && t.data.property === this.data.property && (t.animationIsPlaying = !1)
      },
      addEventListeners: function () {
         var t = this.data,
            e = this.el;
         a(e, t.startEvents, this.onStartEvent), a(e, t.pauseEvents, this.pauseAnimation), a(e, t.resumeEvents, this.resumeAnimation)
      },
      removeEventListeners: function () {
         var t = this.data,
            e = this.el;
         o(e, t.startEvents, this.onStartEvent), o(e, t.pauseEvents, this.pauseAnimation), o(e, t.resumeEvents, this.resumeAnimation)
      },
   ...
   (function (n) {
      ...
      o.defineProperty = "function" == typeof Object.defineProperties ? Object.defineProperty : function (t, e, n) {
         ...
         return o.initSymbolIterator(), t = {
            next: t
         }, t[o.global.Symbol.iterator] = function () {
            return this
         }, t
         ...
         if (e) {
            ...
            t = t[t.length - 1], r = n[t], e = e(r), e != r && null != e && o.defineProperty(n, t, {
               configurable: !0,
               writable: !0,
               value: e
            })
      ...
      ! function (n, o) {
         ...
         function m(t, e) {
            return N.dom(t) && i(D, e) ? "transform" : N.dom(t) && (t.getAttribute(e) || N.svg(t) && t[e]) ? "attribute" : N.dom(t) && "transform" !== e && h(t, e) ? "css" : null != t[e] ? "object" : void 0
         }
         ...
         function g(t, n) {
            ...
            for (var i = [], a = [], o = [], s = /(\w+)\((.+?)\)/g; i = s.exec(t);) a.push(i[1]), o.push(i[2]);
         ...
         function x(t) {
            ...
            switch (t.tagName.toLowerCase()) {
               ...
               case "polygon":
                  var e = t.points;
                  return A(t) + b(e.getItem(e.numberOfItems - 1), e.getItem(0))
            }
         }
         ...
         function w(t, e) {
            ...
            if (n = N.pth(t) ? t.totalLength : t, N.col(n))
               if (N.rgb(n)) {
                  ...
                  n = i ? "rgba(" + i[1] + ",1)" : n
               } else n = N.hex(n) ? f(n) : N.hsl(n) ? l(n) : void 0;
         ...
         function C(t) {
            return t = t ? n(N.arr(t) ? t.map(r) : r(t)) : [], e(t, function (t, e, n) {
         ...
         function I(t, e) {
            ...
            if (N.arr(t)) {
               var i = t.length;
               2 !== i || N.obj(t[0]) ? N.fnc(e.duration) || (n.duration = e.duration / i) : t = {
                  value: t
               }
            }
            return r(t).map(function (t, n) {
               return n = n ? 0 : e.delay, t = N.obj(t) && !N.pth(t) ? t : {
                  value: t
         ...
         function F(t) {
            return N.arr(t) ? $.apply(this, t) : H[t]
         }
         ...
         function S(t, e) {
            ...
            return t.tweens.map(function (r) {
               ...
               var i = r.value,
                  ...
                  s = v(N.arr(i) ? i[1] : i, o),
                  a = c(s) || c(o) || c(a);
               return r.from = w(o, a), r.to = w(s, a), r.start = n ? n.end : t.offset, r.end = r.start + r.delay + r.duration, r.easing = F(r.easing), r.elasticity = (1e3 - Math.min(Math.max(r.elasticity, 1), 999)) / 1e3, r.isPath = N.pth(i), r.isColor = N.col(r.from.original), r.isColor && (r.round = 1), n = r
            })
         }
         ...
         function O(t) {
            var e, n = o(k, t),
               ...
               a = [],
               s = u(n, r);
            for (e in t) s.hasOwnProperty(e) || "targets" === e || a.push({
               name: e,
               offset: s.offset,
               tweens: I(t[e], r)
            });
         ...
         function T(t) {
            ...
            function i(t) {
               for (var n = 0, r = {}, i = d.animations, a = i.length; n < a;) {
                  ...
                  for (var u = Math.min(Math.max(t - l.start - l.delay, 0), l.duration) / l.duration, c = isNaN(u) ? 1 : l.easing(u, l.elasticity), u = l.to.strings, p = l.round, f = [], m = void 0, m = l.to.numbers.length, g = 0; g < m; g++) {
                     var y = void 0,
                        y = l.to.numbers[g],
                        v = l.from.numbers[g],
                        y = l.isPath ? E(l.value, c * y) : v + c * (y - v);
                     p && (l.isColor && 2 < g || (y = Math.round(y * p) / p)), f.push(y)
                  }
                  if (l = u.length)
                     for (m = u[0], c = 0; c < l; c++) p = u[c + 1], g = f[c], isNaN(g) || (m = p ? m + (g + p) : m + (g + " "));
                  else m = f[0];
                  V[o.type](s.target, o.property, m, r, s.id), o.currentValue = m, n++
               }
               if (n = Object.keys(r).length)
                  for (i = 0; i < n; i++) z || (z = h(document.body, "transform") ? "transform" : "-webkit-transform"), d.animatables[i].target.style[z] = r[i].join(" ");
            ...
            function s(t) {
               ...
               if (d.children.length) {
                  var v = d.children,
                     b = v.length;
                  if (y >= d.currentTime)
                     for (var A = 0; A < b; A++) v[A].seek(y);
                  else
                     for (; b--;) v[b].seek(y)
               }(y >= h || !e) && (d.began || (d.began = !0, a("begin")), a("run")), y > s && y < e ? i(y) : (y <= s && 0 !== m && (i(0), g && o()), (y >= e && m !== e || !e) && (i(e), g || o())), a("update"), t >= e && (d.remaining ? (f = u, "alternate" === d.direction && (d.reversed = !d.reversed)) : (d.pause(), d.completed || (d.completed = !0, a("complete"), "Promise" in window && (c(), p = n()))), l = 0)
            }
            t = void 0 === t ? {} : t;
            var u, f, l = 0,
               c = null,
            ...
            return d.reset = function () {
               ...
               var t = W.indexOf(d); - 1 < t && W.splice(t, 1), d.paused = !0
            }, d.play = function () {
               d.paused && (d.paused = !1, f = 0, l = r(d.currentTime), W.push(d), X || Y())
            }, d.reverse = function () {
         ...
         var z, k = {
               ...
               return function (e, n, r, i) {
                  if (0 <= e && 1 >= e && 0 <= r && 1 >= r) {
                     ...
                     return function (o) {
                        ...
                        --u;
                        var u = s + (o - a[u]) / (a[u + 1] - a[u]) * .1,
                           f = 3 * (1 - 3 * r + 3 * e) * u * u + 2 * (3 * r - 6 * e) * u + 3 * e;
                        if (.001 <= f) {
                           for (s = 0; 4 > s && (f = 3 * (1 - 3 * r + 3 * e) * u * u + 2 * (3 * r - 6 * e) * u + 3 * e, 0 !== f); ++s) var l = t(u, e, r) - o,
                              u = u - l / f;
                           o = u
                        } else if (0 === f) o = u;
                        else {
                           var u = s,
                              s = s + .1,
                              c = 0;
                           do l = u + (s - u) / 2, f = t(l, e, r) - o, 0 < f ? s = l : u = l; while (1e-7 < Math.abs(f) && 10 > ++c);
                           o = l
                        }
                        return t(o, n, i)
                     }
            ...
            H = function () {
               ...
               for (e in r) a.type = e, r[a.type].forEach(function (t) {
                  return function (e, r) {
                     i["ease" + t.type + n[r]] = N.fnc(e) ? e : $.apply(s, e)
                  }
               }(a)), a = {
                  type: a.type
               };
            ...
            Y = function () {
               ...
               function e(e) {
                  var n = W.length;
                  if (n) {
                     for (var r = 0; r < n;) W[r] && W[r].tick(e), r++;
                     t()
                  } else cancelAnimationFrame(X), X = 0
               }
               return t
            }();
         return T.version = "2.2.0", T.speed = 1, T.running = W, T.remove = function (t) {
            t = C(t);
            for (var e = W.length; e--;)
               for (var n = W[e], r = n.animations, a = r.length; a--;) i(t, r[a].animatable.target) && (r.splice(a, 1), r.length || n.pause())
         }, T.getValue = y, T.path = function (e, n) {
            ...
            return e.pause(), e.duration = 0, e.add = function (n) {
               return e.children.forEach(function (t) {
                  ...
                  var i = r.offset;
                  r.autoplay = !1, r.direction = e.direction, r.offset = N.und(i) ? n : v(i, n), e.began = !0, e.completed = !0, e.seek(r.offset), r = T(r), r.began = !0, r.completed = !0, r.duration > n && (e.duration = r.duration), e.children.push(r)
